...
Não é opcional e não espera ser pedido: é o que separa "pronto" de um auto-relato. Ele não substitui a revisão geral: o relatório diz "provas verificadas; revisão geral pendente" enquanto ela não rodar.
...
**Escopo**: provas verificadas; revisão geral pendente
